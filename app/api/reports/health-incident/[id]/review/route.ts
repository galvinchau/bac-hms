// web/app/api/reports/health-incident/[id]/review/route.ts
...
export async function PATCH(
  ...
  try {
    ...
    const target = buildUrl(
      BAC_API,
      `/reports/health-incident/${encodeURIComponent(id)}/review`
    );
    ...
    // Pass through status codes (400/401/403/404/etc.)
    try {
